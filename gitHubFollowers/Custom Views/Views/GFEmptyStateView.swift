...
class GFEmptyStateView: UIView {
    ...
    private func configureMessageLabel() {
        ...
        let messageLabelCenterYConstrain = messageLabel.centerYAnchor.constraint(equalTo: self.centerYAnchor, constant: labelCenterYConstant)
        messageLabelCenterYConstrain.isActive = true
